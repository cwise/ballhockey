...
Warbler::Config.new do |config|
  ...
  config.gems << Gem::Dependency.new("actionmailer", "2.3.2")
  config.gems << Gem::Dependency.new("activerecord-jdbc-adapter", "0.9.1")
  config.gems << Gem::Dependency.new("activerecord-jdbcmysql-adapter", "0.9.1")
  config.gems << Gem::Dependency.new("jruby-openssl", "0.4")
  config.gems << Gem::Dependency.new("jdbc-mysql", "5.0.4")
